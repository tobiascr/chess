...
image_K = tk.PhotoImage(file="Images/Chess_klt75.png")
image_Q = tk.PhotoImage(file="Images/Chess_qlt75.png")
image_R = tk.PhotoImage(file="Images/Chess_rlt75.png")
image_B = tk.PhotoImage(file="Images/Chess_blt75.png")
image_N = tk.PhotoImage(file="Images/Chess_nlt75.png")
image_P = tk.PhotoImage(file="Images/Chess_plt75.png")
image_k = tk.PhotoImage(file="Images/Chess_kdt75.png")
image_q = tk.PhotoImage(file="Images/Chess_qdt75.png")
image_r = tk.PhotoImage(file="Images/Chess_rdt75.png")
image_b = tk.PhotoImage(file="Images/Chess_bdt75.png")
image_n = tk.PhotoImage(file="Images/Chess_ndt75.png")
image_p = tk.PhotoImage(file="Images/Chess_pdt75.png")
